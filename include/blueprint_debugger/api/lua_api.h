...
#if defined(BLUEPRINT_LUA_51) || defined(BLUEPRINT_LUA_52)
...
#if defined(BLUEPRINT_LUA_51) || defined(BLUEPRINT_LUA_JIT)
#define LUA_OK 0

int lua_absindex(lua_State *L, int idx);

#ifndef BLUEPRINT_LUA_JIT_SUPPORT_LUA_SETFUNCS
